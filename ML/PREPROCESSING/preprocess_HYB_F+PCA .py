...
data_folder = "/home/rluser/thesis_ws/src/ML/DATA/HYB_FPCA_GRIP_MeanNorm"
...
def preprocess_data(csv_path):
    try:
        ...
        ### POSE ###
            ...
            selected_pose_component = selected_pose_component[np.newaxis,:, np.newaxis] # For depth addition
        ...
        for file in files:
            if file.endswith(".csv"):
                ...
                if X_data is not None and y_data is not None:
                    ...
                    print("X_datashape -->", X_data.shape)
                    c+=1
    return None
